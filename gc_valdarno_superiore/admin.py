...
from models import Segnalazione, DocumentazioneCollegataVs
...
class DocumentazioneCollegataVsAdminForm(forms.ModelForm):

    def __init__(self, *args, **kwargs):
            self.request = kwargs.pop('request', None)
            super(DocumentazioneCollegataVsAdminForm, self).__init__(*args, **kwargs)
            
    class Meta:
        model = DocumentazioneCollegataVs
        fields = '__all__'
        widgets = {
...
class DocumentazioneCollegataVsAdmin(GeoModelAdmin):
    
    form = DocumentazioneCollegataVsAdminForm
...
class DocumentazioneCollegataVsInline(admin.TabularInline):
    model = DocumentazioneCollegataVs
...
class SegnalazioneAdmin(GeoModelAdmin):
    ...
    def save_model(self, request, obj, form, change):
        ...
        if not queryset:
            ...
            codice_segnalazione = 'SEGN-' + 'VS' + '2016' + '00001'
            ...
            codice_segnalazione = 'SEGN-' + 'VS' + '2016' + ultimo[0]
...
#admin.site.register(DocumentazioneCollegataVs, DocumentazioneCollegataVsAdmin)