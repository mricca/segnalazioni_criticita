...
class Segnalazione(gismodels.Model):
    ...
    # OBBLIGATORIO DI DEFAULT
    tipologia_richiesta = gismodels.ForeignKey(TipologiaRichiesta, blank=True, null=True, related_name='tipologia_richiesta_gc_valdarno_superiore',db_index=True, db_column='tipo_rich')
    ...
    # OBBLIGATORIO DI DEFAULT
    inserimento_dods = gismodels.ForeignKey(InserimentoDODS, blank=True, null=True, related_name='inserimento_dods_gc_valdarno_superiore', db_column='ins_dods', verbose_name="Inserimento nel Documento Operativo")
    ...
    # OBBLIGATORIO DI DEFAULT
    set_reg_comp = gismodels.ForeignKey(SettoreRegComp, blank=False, null=True, related_name='set_reg_comp_gc_valdarno_superiore', db_column='set_reg_comp', verbose_name="Settore regionale competente")
...
class DocumentazioneCollegataVs(models.Model):
    ...
    documento_collegato = gismodels.FileField(upload_to='documents/documenti_collegati_vs/%Y/%m/%d',blank=True, null=True, db_column='doc_coll')
