...
from models import Segnalazione, DocumentazioneCollegataTn
...
class DocumentazioneCollegataTnAdminForm(forms.ModelForm):

    def __init__(self, *args, **kwargs):
            self.request = kwargs.pop('request', None)
            super(DocumentazioneCollegataTnAdminForm, self).__init__(*args, **kwargs)
            
    class Meta:
        model = DocumentazioneCollegataTn
        fields = '__all__'
        widgets = {
...
class DocumentazioneCollegataTnAdmin(GeoModelAdmin):
    
    form = DocumentazioneCollegataTnAdminForm
...
class DocumentazioneCollegataTnInline(admin.TabularInline):
    model = DocumentazioneCollegataTn
...
class SegnalazioneAdmin(GeoModelAdmin):
    ...
    fieldsets = [
        ...
        ("DOCUMENTAZIONE COLLEGATA", {"classes": ("placeholder documentazionecollegatatn_set-group",), "fields" : ()}),(
        'STATO ISTRUTTORIA', 
            {'classes': ('grp-collapse grp-open',),'fields': 
                [
                'stato_istruttoria',
    ...
    inlines = [DocumentazioneCollegataTnInline]
    ...
    def save_model(self, request, obj, form, change):
        ...
        if not queryset:
            ...
            codice_segnalazione = 'SEGN-' + 'TN' + '2016' + '00001'
            ...
            codice_segnalazione = 'SEGN-' + 'TN' + '2016' + ultimo[0]
...
#admin.site.register(DocumentazioneCollegataTn, DocumentazioneCollegataTnAdmin)