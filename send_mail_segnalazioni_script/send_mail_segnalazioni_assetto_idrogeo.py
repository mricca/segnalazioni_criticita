...
def doQuery( conn ) :
    ...
    for ogg_segn, data_prot_arr, prot_arrivo, codsegn, data_inizio_istr, data_fine_istr, email_sent in cur.fetchall() :
        ...
        email_content = "Segnalazione n° "+codsegn+"\r\rIn relazione alla segnalazione in oggetto si comunica che in data odierna è stato oltrepassato il termine dei 30 giorni dall'apertura dell'istruttoria.\rTale istruttoria é stata aperta in data "+str(data_prot_arr)+" con protocollo "+prot_arrivo+".\rSe ne sollecita pertanto il completamento entro la prossima settimana.\r\r------\rCordiali salutiLa Direzione"
