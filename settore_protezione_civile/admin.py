...
from models import Segnalazione, DocumentazioneCollegataPc
...
class DocumentazioneCollegataPcAdminForm(forms.ModelForm):

    def __init__(self, *args, **kwargs):
            self.request = kwargs.pop('request', None)
            super(DocumentazioneCollegataPcAdminForm, self).__init__(*args, **kwargs)
            
    class Meta:
        model = DocumentazioneCollegataPc
        fields = '__all__'
        widgets = {
...
class DocumentazioneCollegataPcAdmin(GeoModelAdmin):
    
    form = DocumentazioneCollegataPcAdminForm
...
class DocumentazioneCollegataPcInline(admin.TabularInline):
    model = DocumentazioneCollegataPc
...
class SegnalazioneAdmin(GeoModelAdmin):
    ...
    fieldsets = [
        ...
        ("DOCUMENTAZIONE COLLEGATA", {"classes": ("placeholder documentazionecollegatapc_set-group",), "fields" : ()}),(
        'STATO ISTRUTTORIA', 
            {'classes': ('grp-collapse grp-open',),'fields': 
                [
                'stato_istruttoria',
    ...
    inlines = [DocumentazioneCollegataPcInline]
    ...
    def save_model(self, request, obj, form, change):
        ...
        if not queryset:
            ...
            codice_segnalazione = 'SEGN-' + 'PC' + '2016' + '00001'
            ...
            codice_segnalazione = 'SEGN-' + 'PC' + '2016' + ultimo[0]
...
#admin.site.register(DocumentazioneCollegataPc, DocumentazioneCollegataPcAdmin)