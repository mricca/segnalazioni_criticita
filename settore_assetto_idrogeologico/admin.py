...
from models import Segnalazione, DocumentazioneCollegataAi
...
class DocumentazioneCollegataAiAdminForm(forms.ModelForm):

    def __init__(self, *args, **kwargs):
            self.request = kwargs.pop('request', None)
            super(DocumentazioneCollegataAiAdminForm, self).__init__(*args, **kwargs)
            
    class Meta:
        model = DocumentazioneCollegataAi
        fields = '__all__'
        widgets = {
...
class DocumentazioneCollegataAiAdmin(GeoModelAdmin):
    
    form = DocumentazioneCollegataAiAdminForm
...
class DocumentazioneCollegataAiInline(admin.TabularInline):
    model = DocumentazioneCollegataAi
...
class SegnalazioneAdmin(GeoModelAdmin):
    ...
    fieldsets = [
        ...
        ("DOCUMENTAZIONE COLLEGATA", {"classes": ("placeholder documentazionecollegataai_set-group",), "fields" : ()}),(
        'STATO ISTRUTTORIA', 
            {'classes': ('grp-collapse grp-open',),'fields': 
                [
                'stato_istruttoria',
    ...
    inlines = [DocumentazioneCollegataAiInline]
    ...
    def save_model(self, request, obj, form, change):
        ...
        if not queryset:
            ...
            codice_segnalazione = 'SEGN-' + 'AI' + '2016' + '00001'
            ...
            codice_segnalazione = 'SEGN-' + 'AI' + '2016' + ultimo[0]
...
#admin.site.register(DocumentazioneCollegataAi, DocumentazioneCollegataAiAdmin)