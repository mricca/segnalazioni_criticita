...
from models import Segnalazione, DocumentazioneCollegataVc
...
class DocumentazioneCollegataVcAdminForm(forms.ModelForm):

    def __init__(self, *args, **kwargs):
            self.request = kwargs.pop('request', None)
            super(DocumentazioneCollegataVcAdminForm, self).__init__(*args, **kwargs)
            
    class Meta:
        model = DocumentazioneCollegataVc
        fields = '__all__'
        widgets = {
...
class DocumentazioneCollegataVcAdmin(GeoModelAdmin):
    
    form = DocumentazioneCollegataVcAdminForm
...
class DocumentazioneCollegataVcInline(admin.TabularInline):
    model = DocumentazioneCollegataVc
...
class SegnalazioneAdmin(GeoModelAdmin):
    ...
    fieldsets = [
        ...
        ("DOCUMENTAZIONE COLLEGATA", {"classes": ("placeholder documentazionecollegatavc_set-group",), "fields" : ()}),(
        'STATO ISTRUTTORIA', 
            {'classes': ('grp-collapse grp-open',),'fields': 
                [
                'stato_istruttoria',
    ...
    def save_model(self, request, obj, form, change):
        ...
        if not queryset:
            ...
            codice_segnalazione = 'SEGN-' + 'VC' + '2016' + '00001'
            ...
            codice_segnalazione = 'SEGN-' + 'VC' + '2016' + ultimo[0]
...
#admin.site.register(DocumentazioneCollegataVc, DocumentazioneCollegataVcAdmin)