...
from models import Segnalazione, DocumentazioneCollegataTs
...
class DocumentazioneCollegataTsAdminForm(forms.ModelForm):

    def __init__(self, *args, **kwargs):
            self.request = kwargs.pop('request', None)
            super(DocumentazioneCollegataTsAdminForm, self).__init__(*args, **kwargs)
            
    class Meta:
        model = DocumentazioneCollegataTs
        fields = '__all__'
        widgets = {
...
class DocumentazioneCollegataTsAdmin(GeoModelAdmin):
    
    form = DocumentazioneCollegataTsAdminForm
...
class DocumentazioneCollegataTsInline(admin.TabularInline):
    model = DocumentazioneCollegataTs
...
class SegnalazioneAdmin(GeoModelAdmin):
    ...
    fieldsets = [
        ...
        ("DOCUMENTAZIONE COLLEGATA", {"classes": ("placeholder documentazionecollegatats_set-group",), "fields" : ()}),(
        'STATO ISTRUTTORIA', 
            {'classes': ('grp-collapse grp-open',),'fields': 
                [
                'stato_istruttoria',
    ...
    inlines = [DocumentazioneCollegataTsInline]
    ...
    def save_model(self, request, obj, form, change):
        ...
        if not queryset:
            ...
            codice_segnalazione = 'SEGN-' + 'TS' + '2016' + '00001'
            ...
            codice_segnalazione = 'SEGN-' + 'TS' + '2016' + ultimo[0]
...
#admin.site.register(DocumentazioneCollegataTs, DocumentazioneCollegataTsAdmin)